...
public class GlobalExceptionHandler {
    ...
    public Result<Object> handleThrowable(HttpServletRequest request, Throwable e) {
        ...
        return Result.failure(RestResultStatus.INTERNAL_SERVER_ERROR, e);
    }

    /**
     * SpringSecurity 无权限异常
     *
     * @param request
     * @param e
     * @return
    ...
    public Result<Object> handleAccessDeniedException(HttpServletRequest request, Throwable e) {
        return Result.failure(RestResultStatus.AUTHENTIZATION_ERROR);
    }
    ...
    public Result handleJSR303Exception(HttpServletRequest request, Exception e) {
        ...
        result.setCode(RestResultStatus.PARAM_ERROR.getCode());
        result.setMessage(RestResultStatus.PARAM_ERROR.getMessage());
        result.setResult(e);
    ...
    public Result handleSQLSyntaxErrorException(HttpServletRequest request, BadSqlGrammarException e) {
        ...
        return Result.failure(RestResultStatus.INTERNAL_SERVER_ERROR, message);
    }
